...
def assign_uv_tex_material(obj):
    ...
    for face in bm.faces:
        ...
        # Construct the material key using the base name and texture suffix
        texture_suffix = int_to_texture_suffix(tex_num)
        material_key = f"{base_name}{texture_suffix}.bmp"
...
def int_to_texture_suffix(tex_num):
    # Convert an integer to a texture suffix (a, b, c, ..., z, aa, ab, ...)
